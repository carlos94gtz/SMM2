...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--scan-margin", type=int, default=5000, help="Extra IDs to scan before and after the estimate.")
    parser.add_argument("--max-extensions", type=int, default=4, help="How many times to extend the scan if coverage is incomplete.")
    ...
    parser.add_argument("--thumbnail-timeout", type=float, default=20.0)
    parser.add_argument("--thumbnail-retries", type=int, default=5)
    parser.add_argument("--thumbnail-delay", type=float, default=0.35)
